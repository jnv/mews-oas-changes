...
- :warning: added the new 'Cabin' enum value to the 'Configurations/items/Enterprise/allOf[subschema #1: Enterprise]/Categories/items/SpaceType' response property for the response status '200'
- :warning: added the new 'Pod' enum value to the 'Configurations/items/Enterprise/allOf[subschema #1: Enterprise]/Categories/items/SpaceType' response property for the response status '200'
- :warning: added the new 'SunBed' enum value to the 'Configurations/items/Enterprise/allOf[subschema #1: Enterprise]/Categories/items/SpaceType' response property for the response status '200'
...
- :warning: added the new 'Cabin' enum value to the 'RoomCategories/items/SpaceType' response property for the response status '200'
- :warning: added the new 'Pod' enum value to the 'RoomCategories/items/SpaceType' response property for the response status '200'
- :warning: added the new 'SunBed' enum value to the 'RoomCategories/items/SpaceType' response property for the response status '200'
...
- :warning: added the new 'Cabin' enum value to the 'ViolatedRestrictions/items/Conditions/allOf[subschema #1: RestrictionConditions]/ResourceCategoryType/anyOf[#/components/schemas/ResourceCategoryType]/' response property for the response status '200'
- :warning: added the new 'Pod' enum value to the 'ViolatedRestrictions/items/Conditions/allOf[subschema #1: RestrictionConditions]/ResourceCategoryType/anyOf[#/components/schemas/ResourceCategoryType]/' response property for the response status '200'
- :warning: added the new 'SunBed' enum value to the 'ViolatedRestrictions/items/Conditions/allOf[subschema #1: RestrictionConditions]/ResourceCategoryType/anyOf[#/components/schemas/ResourceCategoryType]/' response property for the response status '200'
...
- :warning: added the new 'Cabin' enum value to the 'ApplicableRestrictions/items/Conditions/allOf[subschema #1: RestrictionConditions]/ResourceCategoryType/anyOf[#/components/schemas/ResourceCategoryType]/' response property for the response status '200'
- :warning: added the new 'Pod' enum value to the 'ApplicableRestrictions/items/Conditions/allOf[subschema #1: RestrictionConditions]/ResourceCategoryType/anyOf[#/components/schemas/ResourceCategoryType]/' response property for the response status '200'
- :warning: added the new 'SunBed' enum value to the 'ApplicableRestrictions/items/Conditions/allOf[subschema #1: RestrictionConditions]/ResourceCategoryType/anyOf[#/components/schemas/ResourceCategoryType]/' response property for the response status '200'
...
- :warning: added the new 'Cabin' enum value to the 'ResourceCategories/items/SpaceType' response property for the response status '200'
- :warning: added the new 'Pod' enum value to the 'ResourceCategories/items/SpaceType' response property for the response status '200'
- :warning: added the new 'SunBed' enum value to the 'ResourceCategories/items/SpaceType' response property for the response status '200'
